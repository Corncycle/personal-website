...
const projectData = [
  {
    ...
    description:
      'An image searching game bootstrapped by create-react-app. High scores are stored and retrieved from a Firestore database to be compared online.',
  ...
  },
  {
    ...
    name: 'Smash Memory',
    description:
      'An in-browser game to test memory of previously selected Smash Bros. fighters. High scores are stored using the localStorage API. Assets were scraped from smashbros.com using axios in Node.js',
  ...
  },
  {
    ...
    description:
      'The site you are currently on! This site was made in React, with client-side routing from React Router. It has a responsive design with a collapsible nav bar for mobile.',
